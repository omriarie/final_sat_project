...
if __name__ == '__main__':
    source = "https://ladsweb.modaps.eosdis.nasa.gov/archive/orders/502323964/"
    ...
    for folder in os.listdir(destination_without_temp):
        ...
        if os.path.isdir(folder_path):  # Ensure it's a directory
            ...
            download_goes_data(date_time, folder_path, "goes16")
            download_goes_data(date_time, folder_path, "goes17")
    # Iterate through all folders in the main directory
            folder_path_16 = os.path.join(folder_path, "noaa-goes16")
            if os.path.isdir(folder_path_16):  # Ensure it's a directory
                move_files_to_parent(folder_path_16, folder_path)
            folder_path_17 = os.path.join(folder_path, "noaa-goes17")
            if os.path.isdir(folder_path_17):  # Ensure it's a directory
                move_files_to_parent(folder_path_17 ,folder_path )
